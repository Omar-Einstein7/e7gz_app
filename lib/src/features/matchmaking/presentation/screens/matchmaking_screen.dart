  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (state.status == MatchmakingStatus.loading)
                    ...
                    Center(child: Text(state.errorMessage ?? 'Error loading matches'))
                  else if (state.matches.isEmpty)
                    const Center(child: Text('No matches available at the moment'))
                  else
                    // Matches
                    ...state.matches.map((match) {
                      return Padding(
                        ...
                        child: MatchmakingCard(
                          ...
                          onJoin: () => context.read<MatchmakingCubit>().joinMatch(match.id),
                        ),
                      );
                    }),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {}, // TODO: Open Create Match dialog
